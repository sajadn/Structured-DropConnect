...
class Cifar10Model(resnet_model.Model):
  ...
  def __init__(self, resnet_size, data_format=None, num_classes=_NUM_CLASSES,
               ...
               dtype=resnet_model.DEFAULT_DTYPE, dropout=None):
...
def cifar10_model_fn(features, labels, mode, params):
  ...
  learning_rate_fn = resnet_run_loop.learning_rate_with_decay(
      batch_size=params['batch_size'], batch_denom=BATCH_SIZE,
  ...
  if sys.argv[2]=='linear':
      dropout_prob_fn = resnet_run_loop.dropout_prob_with_decay_linear(
          batch_size=params['batch_size'], batch_denom=BATCH_SIZE,
          num_images=_NUM_IMAGES['train'], decay_epochs=200, base_prob=1, end_prob=0.95)
  else:
      dropout_prob_fn = resnet_run_loop.dropout_prob_with_decay_piece_wise(
          batch_size=params['batch_size'], batch_denom=BATCH_SIZE,
          num_images=_NUM_IMAGES['train'], boundary_epochs=[40, 70, 100, 150, 200], base_prob=1,
